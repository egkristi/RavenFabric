class Ravenfabric < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/egkristi/RavenFabric-Published/releases/download/v0.2.1/ravenfabric-darwin-arm64-cli"
      sha256 "faf2615ace5237b9729621e4af9fb0b28a983bde673068efa01ab7fbba455353"
    else
      url "https://github.com/egkristi/RavenFabric-Published/releases/download/v0.2.1/ravenfabric-darwin-amd64-cli"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/egkristi/RavenFabric-Published/releases/download/v0.2.1/ravenfabric-linux-arm64-musl-cli"
      sha256 "4007bba6bde405b08a4eda3f60a89678e1cbf4e6ac66fa257127ddf50ddbb88f"
    elsif Hardware::CPU.intel?
      url "https://github.com/egkristi/RavenFabric-Published/releases/download/v0.2.1/ravenfabric-linux-amd64-musl-cli"

...
| `rf-rpc` | Message types, msgpack codec, yamux mux, DTN, routing, controller API | ~6,300 | 112 |
...
| `rf-mcp-server` | MCP server for AI agent integration (Claude, Cursor, Aider) | ~3,300 | 46 |
...
**Total: ~58,400 LOC | 1,179 tests | 0 clippy warnings**
